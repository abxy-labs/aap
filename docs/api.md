...
## Public institution discovery

An institution can serve unauthenticated `GET /.well-known/aap` on its own
origin, pointing to this API. See [Institution discovery](discovery.md) for the
