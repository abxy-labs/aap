...
at `/.well-known/aap` on your site origin. Generate it with
`aap discovery create --origin https://bank.example --api-base https://aap.example --out aap.json`.
See [Site discovery](../discovery.md) for hosting. Publishing this file does not replace configuring your policy.
